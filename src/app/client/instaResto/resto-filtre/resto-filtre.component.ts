...
@Component({
  selector: 'app-resto-filtre',
  templateUrl: './resto-filtre.component.html',
  styleUrls: ['./resto-filtre.component.css']
})
export class RestoFiltreComponent implements OnInit {
  opt:string;
  FirOutput: any=[];
